...
features = (
    ...
    #{'name': 'PcaVar2dU', 'bins': np.linspace(0, 10, num=50), 'showerCutDirection': 'right'},
    #{'name': 'PcaVar2dV', 'bins': np.linspace(0, 10, num=50), 'showerCutDirection': 'right'},
    #{'name': 'PcaVar2dW', 'bins': np.linspace(0, 10, num=50), 'showerCutDirection': 'right'},
