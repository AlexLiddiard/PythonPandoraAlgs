...
dataFolder = ds.myTestArea + '/PythonPandoraAlgs/TrackShowerData/'
...
trainingPreFilters = ds.ProcessFilters(trainingPreFilters)
performancePreFilters = ds.ProcessFilters(performancePreFilters)