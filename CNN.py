...
import PfoGraphicalAnalyser as pga

def PlotPFOSVG(driftCoords, wireCoords, driftCoordErrors, energies, fileName, driftSpan = 100, wireSpan = 100):
...
def ProcessFile(filePath):
    ...
    for className, classQuery in gc.classes.items():
        ...
        for index, pfoGeneralInfo in dfClass.iterrows():
            ...
            PlotPFOSVG(pfo.driftCoordW, pfo.wireCoordW, pfo.driftCoordErrW, pfo.energyW, "%s/%s/%s_%s_%s_v001.png" %(cc.outputFolder, className, pfo.fileName, pfo.eventId, pfo.pfoId), *cc.imageSpan["W"])
            PlotPFOSVG(pfo.driftCoordU, pfo.wireCoordU, pfo.driftCoordErrU, pfo.energyU, "%s/%s/%s_%s_%s_v002.png" %(cc.outputFolder, className, pfo.fileName, pfo.eventId, pfo.pfoId), *cc.imageSpan["U"])
            PlotPFOSVG(pfo.driftCoordV, pfo.wireCoordV, pfo.driftCoordErrV, pfo.energyV, "%s/%s/%s_%s_%s_v003.png" %(cc.outputFolder, className, pfo.fileName, pfo.eventId, pfo.pfoId), *cc.imageSpan["V"])
