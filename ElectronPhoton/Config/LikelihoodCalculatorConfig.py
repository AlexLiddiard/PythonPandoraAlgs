...
features = [
    ...
    {'name': 'TestDeDxU', 'algorithmName': 'TestDeDx1', 'pdfBins': np.linspace(0, 500, num=50)},
    {'name': 'TestDeDxV', 'algorithmName': 'TestDeDx1', 'pdfBins': np.linspace(0, 500, num=50)},
    {'name': 'TestDeDxW', 'algorithmName': 'TestDeDx1', 'pdfBins': np.linspace(0, 300, num=50)},
    {'name': 'TestDeDx3D', 'algorithmName': 'TestDeDx1', 'pdfBins': np.linspace(0, 500, num=50)},
    {'name': 'TestDeDx2U', 'algorithmName': 'TestDeDx2', 'pdfBins': np.linspace(0, 1200, num=50)},
    {'name': 'TestDeDx2V', 'algorithmName': 'TestDeDx2', 'pdfBins': np.linspace(0, 1200, num=50)},
    ...
    {'name': 'dedxU', 'algorithmName': 'NewInitialDeDx', 'pdfBins': np.linspace(0, 2000, num=50)},
    {'name': 'dedxV', 'algorithmName': 'NewInitialDeDx', 'pdfBins': np.linspace(0, 2000, num=50)},
    {'name': 'dedxW', 'algorithmName': 'NewInitialDeDx', 'pdfBins': np.linspace(0, 1000, num=50)},
]