...
features = [
    ...
    {'name': 'TestDeDxU', 'algorithmName': 'TestDeDx1'},
    {'name': 'TestDeDxV', 'algorithmName': 'TestDeDx1'},
    {'name': 'TestDeDxW', 'algorithmName': 'TestDeDx1'},
    {'name': 'TestDeDx3D', 'algorithmName': 'TestDeDx1'},
    {'name': 'TestDeDx2U', 'algorithmName': 'TestDeDx2'},
    {'name': 'TestDeDx2V', 'algorithmName': 'TestDeDx2'},
    {'name': 'TestDeDx2W', 'algorithmName': 'TestDeDx2'},
    {'name': 'TestDeDx2_3D', 'algorithmName': 'TestDeDx2'},
