...
features = [
    {'name': 'TotalChargeU', 'algorithmName': 'TotalCharge', 'bins': np.linspace(0, 20000, num = 50), 'cutDirection': 'left'},
    {'name': 'TotalChargeV', 'algorithmName': 'TotalCharge', 'bins': np.linspace(0, 20000, num = 50), 'cutDirection': 'left'},
    {'name': 'TotalChargeW', 'algorithmName': 'TotalCharge', 'bins': np.linspace(0, 20000, num = 50), 'cutDirection': 'left'},
    {'name': 'TotalCharge3D', 'algorithmName': 'TotalCharge', 'bins': np.linspace(0, 20000, num = 50), 'cutDirection': 'left'},
    ...
    {'name': 'BDTU', 'algorithmName': 'BDTCalculator', 'bins': np.linspace(-5, 10, num = 50), 'cutDirection': 'left'},
    {'name': 'BDTV', 'algorithmName': 'BDTCalculator', 'bins': np.linspace(-5, 10, num = 50), 'cutDirection': 'left'},
    {'name': 'BDTW', 'algorithmName': 'BDTCalculator', 'bins': np.linspace(-5, 10, num = 50), 'cutDirection': 'left'},
    {'name': 'BDT3D', 'algorithmName': 'BDTCalculator', 'bins': np.linspace(-5, 10, num = 50), 'cutDirection': 'left'},
    {'name': 'BDTMulti', 'algorithmName': 'BDTCalculator', 'bins': np.linspace(-5, 10, num = 50), 'cutDirection': 'left'},
    ...
    {'name': 'nuMcpMomentum', 'algorithmName': 'GeneralInfo', 'bins': np.linspace(0, 2, num = 50), 'cutDirection': 'left'},
