...
features = [
    ...
    #{'name': 'TestDeDxU', 'algorithmName': 'TestDeDx1', 'bins': np.linspace(0, 400, num=50), 'cutDirection': 'left'},
    #{'name': 'TestDeDxV', 'algorithmName': 'TestDeDx1', 'bins': np.linspace(0, 600, num=50), 'cutDirection': 'left'},
    #{'name': 'TestDeDxW', 'algorithmName': 'TestDeDx1', 'bins': np.linspace(0, 600, num=50), 'cutDirection': 'left'},
    #{'name': 'TestDeDx3D', 'algorithmName': 'TestDeDx1', 'bins': np.linspace(0, 600, num=50), 'cutDirection': 'left'},
