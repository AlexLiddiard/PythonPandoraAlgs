...
features = [
    ...
    {'name': 'dedxU', 'algorithmName': 'NewInitialDeDx', 'bins': np.linspace(0, 2000, num=30), 'cutDirection': 'right'},
    {'name': 'dedxV', 'algorithmName': 'NewInitialDeDx', 'bins': np.linspace(0, 2000, num=30), 'cutDirection': 'right'},
    {'name': 'dedxW', 'algorithmName': 'NewInitialDeDx', 'bins': np.linspace(0, 2000, num=30), 'cutDirection': 'right'},
    ...
    {'name': 'mcpMomentum', 'algorithmName': 'GeneralInfo', 'bins': np.linspace(0, 4, num = 30), 'cutDirection': 'right'},
...
featureHistogram = {
    "plot": True,
    "filters": (
        ("Photon", "abs(mcPdgCode)==22", "abs(mcPdgCode) in (11, 22)", True),
        ("Electron", "abs(mcPdgCode)==11", "abs(mcPdgCode) in (11, 22)", True),
