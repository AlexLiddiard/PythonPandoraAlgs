...
preFilters = {
    "training": {
        ...
        "U": (
            '(isElectron==1 and purityU>=0.8) or (isElectron==0 and purityU>=0.8)',
            '(isElectron==1 and completenessU>=0.5) or (isElectron==0 and completenessU>=0.8)',
            #'nHitsU>=50',
        ),
        "V": (
            '(isElectron==1 and purityV>=0.8) or (isElectron==0 and purityV>=0.8)',
            '(isElectron==1 and completenessV>=0.5) or (isElectron==0 and completenessV>=0.8)',
            #'nHitsV>=50',
        ),
        "W": (
            '(isElectron==1 and purityW>=0.8) or (isElectron==0 and purityW>=0.8)',
            '(isElectron==1 and completenessW>=0.5) or (isElectron==0 and completenessW>=0.8)',
            #'nHitsW>=50',
        ),
        "3D":
        (
