...
features = [
    ...
    #{'name': 'maxCoordX3D', 'algorithmName': 'GeneralInfo', 'bins': np.linspace(MicroBooneGeo.RangeX[0], MicroBooneGeo.RangeX[1], num = 50), 'cutDirection': '', 'cutFixed':  MicroBooneGeo.RangeX[1] - 10, 'cutPlot': "simple"},
