...
featurePdfs = (
    ...
    #{'name': 'LongitudinalSpan3D', 'bins': np.linspace(0, 600, num=50)},
    #{'name': 'PcaVarU', 'bins': np.linspace(0, 10, num=50)},
    #{'name': 'PcaVarV', 'bins': np.linspace(0, 10, num=50)},
    #{'name': 'PcaVarW', 'bins': np.linspace(0, 10, num=50)},
    #{'name': 'PcaVar3D', 'bins': np.linspace(0, 10, num=50)},
    #{'name': 'PcaRatioU', 'bins': np.linspace(0, 0.4, num=50)},
    #{'name': 'PcaRatioV', 'bins': np.linspace(0, 0.4, num=50)},
    #{'name': 'PcaRatioW', 'bins': np.linspace(0, 0.4, num=50)},
    {'name': 'PcaRatio3D', 'bins': np.linspace(0, 0.4, num=50)},
