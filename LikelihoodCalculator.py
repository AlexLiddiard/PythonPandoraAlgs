...
featurePdfs = (
    ...
    #{'name': 'PcaVar2dU', 'bins': np.linspace(0, 10, num=50)},
    #{'name': 'PcaVar2dV', 'bins': np.linspace(0, 10, num=50)},
    #{'name': 'PcaVar2dW', 'bins': np.linspace(0, 10, num=50)},
    #{'name': 'PcaVar3d', 'bins': np.linspace(0, 10, num=50)},
    #{'name': 'PcaRatio2dU', 'bins': np.linspace(0, 0.4, num=50)},
    #{'name': 'PcaRatio2dV', 'bins': np.linspace(0, 0.4, num=50)},
    #{'name': 'PcaRatio2dW', 'bins': np.linspace(0, 0.4, num=50)},
